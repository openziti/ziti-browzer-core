...
import { addEventListener, removeEventListener } from './event-target';
...
async function initAsClient(websocket, address, protocols, options) {
    ...
    let request = new ZitiHttpRequest(serviceName, opts.href, opts);
